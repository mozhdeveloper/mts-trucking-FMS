    ...
    <div className="space-y-6">
      ...
      <Card className="border-dashed border-2">
        <CardContent className="p-6 text-center">
          <p className="text-sm text-muted-foreground">This module is part of the full MTS Trucking platform. The MVP includes core operations: Fleet, Drivers, Trips, GPS, PMS, Expenses, Payroll, POD, and Reports.</p>
        </CardContent>
      </Card>
    </div>
  );
