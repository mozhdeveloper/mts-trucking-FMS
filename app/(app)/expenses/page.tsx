        ...
        <div className="space-y-4 xl:space-y-6">
          ...
          <Card className="shadow-sm border-brand-border">
            ...
            <CardContent className="p-4 space-y-4 text-xs xl:text-[13px]">
              <TopVehicle row="MTS-101" desc="Isuzu FTR 24ft" amt="₱245,670.50" pct="19.7%" percentBar="w-[80%]" />
              <TopVehicle row="MTS-104" desc="Hino 500" amt="₱198,320.00" pct="15.9%" percentBar="w-[60%]" />
              <TopVehicle row="MTS-102" desc="Fuso Canter" amt="₱156,840.00" pct="12.6%" percentBar="w-[45%]" />
              <TopVehicle row="MTS-103" desc="Toyota Hiace" amt="₱123,450.75" pct="9.9%" percentBar="w-[35%]" />
              <TopVehicle row="MTS-106" desc="Toyota Hilux" amt="₱98,760.25" pct="7.9%" percentBar="w-[20%]" />
            </CardContent>
          </Card>
