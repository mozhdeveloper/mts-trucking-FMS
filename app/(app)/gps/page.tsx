            ...
            <div className="divide-y divide-brand-border/60">
              <div className="p-3 flex items-start gap-3 hover:bg-gray-50 transition-colors">
                ...
                <div className="flex-1 min-w-0 flex justify-between gap-2">
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-brand-navy truncate">Geofence Exit (MTS-101)</p>
              ...
              <div className="p-3 flex items-start gap-3 hover:bg-gray-50 transition-colors">
                ...
                <div className="flex-1 min-w-0 flex justify-between gap-2">
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-brand-navy truncate">High Speed (MTS-104)</p>
              ...
              <div className="p-3 flex items-start gap-3 hover:bg-gray-50 transition-colors">
                ...
                <div className="flex-1 min-w-0 flex justify-between gap-2">
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-brand-navy truncate">Low Fuel (MTS-109)</p>
        ...
        <Card className="shadow-sm border-brand-border md:col-span-2 lg:col-span-1">
          ...
          <CardContent className="p-4 flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-2">
              <Select defaultValue="mts101">
                <SelectTrigger className="w-full sm:flex-1 text-sm h-9">
                  <SelectValue placeholder="Vehicle" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="mts101">MTS-101</SelectItem>
                  <SelectItem value="mts102">MTS-102</SelectItem>
                </SelectContent>
              </Select>
