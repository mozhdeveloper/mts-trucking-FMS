...
export default function AiInsightsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="AI Insights" subtitle="Predictive analytics and actionable recommendations powered by MTS AI" breadcrumbs={[{ label: "Reports" }, { label: "AI Insights" }]} />
        ...
        <CardContent className="p-8 grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-brand-teal">MTS AI Engine</span>
            </div>
            <h2 className="text-3xl font-bold mb-3">Your fleet is performing 12% above industry average.</h2>
            <p className="text-white/80 max-w-2xl">MTS AI continuously analyzes your fleet data — driver behavior, fuel patterns, maintenance trends, and route efficiency — to surface actionable insights that drive cost reduction and operational excellence.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <PredictiveCard icon={TrendingUp} color="text-emerald-600" bg="bg-emerald-50" title="Fuel Anomaly Detection" desc="MTS-104 consuming 15% above baseline — recommend ECU diagnostic & driver coaching." metric="Saves ₱18K/mo" />
