    ...
    <div className="min-h-[100dvh] w-full flex flex-col bg-gray-50 overscroll-none">
      ...
      >
        <div className="max-w-lg mx-auto h-14 px-4 flex items-center justify-between">
          ...
          {/* Brand — identical to driver page */}
        ...
        {/* Red accent bottom line — matches driver page */}
        <div className="h-[2px] bg-brand-red" />
      </header>

      {/* ── Title banner ── */}
      <div className="bg-brand-black px-5 pt-4 pb-5 shrink-0" style={{ backgroundImage: "repeating-linear-gradient(45deg, rgba(227,0,15,0.05) 0 1px, transparent 1px 12px)" }}>
        <div className="max-w-lg mx-auto">
          ...
          <div className="flex gap-2 mt-4">
            <span className="flex items-center gap-1.5 bg-amber-500/20 border border-amber-500/30 text-amber-300 text-xs font-bold font-display uppercase tracking-wider px-3 py-1.5">
              <span className="w-1.5 h-1.5 bg-amber-400" />
              {myNeedsPod.length} Pending
            </span>
            <span className="flex items-center gap-1.5 bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 text-xs font-bold font-display uppercase tracking-wider px-3 py-1.5">
                ...
                {myNeedsPod.map((t) => (
                  ...
                  >
                    ...
                    <div className="shrink-0 flex flex-col items-center gap-1">
                      <div className="w-8 h-8 bg-brand-red-light flex items-center justify-center">
